...
$(BUILD_DIR)/main.o : $(USER_DIR)/main.cpp $(USER_DIR)/main.h $(DEPS) $(GTEST_HEADERS)
	$(CC) $(CPPFLAGS) $(CXXFLAGS) -c $(USER_DIR)/main.cpp -o $@

$(BUILD_DIR)/main : $(BUILD_DIR)/main.o $(BUILD_DIR)/gtest_main.a
	$(CC) $(CPPFLAGS) $(CXXFLAGS) -lpthread $^ -o $@

# main_unittest.o : $(USER_DIR)/sample1_unittest.cc \
