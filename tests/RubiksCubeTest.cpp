...
TEST_F(CubeFixture, xleft_face_rotation_180) {
    ...
    expectedZFront->setCol(0, getArrayOfColor(CubeFace::Orange));
    expectedYBottom->setCol(0, getArrayOfColor(CubeFace::White));
    expectedZBack->setCol(0, getArrayOfColor(CubeFace::Red));
...
TEST_F(CubeFixture, xleft_face_rotation_270) {
    expectedYTop->setCol(0, getArrayOfColor(CubeFace::Red));
    expectedZFront->setCol(0, getArrayOfColor(CubeFace::Yellow));
    expectedYBottom->setCol(0, getArrayOfColor(CubeFace::Orange));
...
TEST_F(CubeFixture, xright_face_rotation_180) {
    ...
    expectedZFront->setCol(2, getArrayOfColor(CubeFace::Orange));
    expectedYBottom->setCol(2, getArrayOfColor(CubeFace::White));
    expectedZBack->setCol(2, getArrayOfColor(CubeFace::Red));
...
TEST_F(CubeFixture, xright_face_rotation_270) {
    expectedYTop->setCol(2, getArrayOfColor(CubeFace::Orange));
    expectedZFront->setCol(2, getArrayOfColor(CubeFace::White));
    expectedYBottom->setCol(2, getArrayOfColor(CubeFace::Red));
...
TEST_F(CubeFixture, ytop_face_rotation_270) {
    expectedXLeft->setRow(0, getArrayOfColor(CubeFace::Orange));
    expectedZBack->setRow(0, getArrayOfColor(CubeFace::Blue));
    expectedXRight->setRow(0, getArrayOfColor(CubeFace::Red));
    expectedZFront->setRow(0, getArrayOfColor(CubeFace::Green));
...
TEST_F(CubeFixture, zfront_face_rotation_180) {
    ...
    expectedXRight->setCol(0, getArrayOfColor(CubeFace::Green));
    expectedYBottom->setRow(0, getArrayOfColor(CubeFace::White));
    expectedXLeft->setCol(2, getArrayOfColor(CubeFace::Blue));
...
TEST_F(CubeFixture, zfront_face_rotation_270) {
    expectedYTop->setRow(2, getArrayOfColor(CubeFace::Blue));
    expectedXRight->setCol(0, getArrayOfColor(CubeFace::Yellow));
    expectedYBottom->setRow(0, getArrayOfColor(CubeFace::Green));
...
TEST_F(CubeFixture, zback_face_rotation_180) {
    ...
    expectedXLeft->setCol(0, getArrayOfColor(CubeFace::Blue));
    expectedYBottom->setRow(2, getArrayOfColor(CubeFace::White));
    expectedXRight->setCol(2, getArrayOfColor(CubeFace::Green));
...
TEST_F(CubeFixture, zback_face_rotation_270) {
    expectedYTop->setRow(0, getArrayOfColor(CubeFace::Green));
    expectedXLeft->setCol(0, getArrayOfColor(CubeFace::Yellow));
    expectedYBottom->setRow(2, getArrayOfColor(CubeFace::Blue));
...
TEST_F(CubeFixture, x_slice_rotation_270) {
    expectedYTop->setCol(1, getArrayOfColor(CubeFace::Red));
    expectedZFront->setCol(1, getArrayOfColor(CubeFace::Yellow));
    expectedYBottom->setCol(1, getArrayOfColor(CubeFace::Orange));
...
TEST_F(CubeFixture, z_slice_rotation_180) {
    ...
    expectedXRight->setCol(1, getArrayOfColor(CubeFace::Green));
    expectedYBottom->setRow(1, getArrayOfColor(CubeFace::White));
    expectedXLeft->setCol(1, getArrayOfColor(CubeFace::Blue));
...
TEST_F(CubeFixture, z_slice_rotation_270) {
    expectedYTop->setRow(1, getArrayOfColor(CubeFace::Blue));
    expectedXRight->setCol(1, getArrayOfColor(CubeFace::Yellow));
    expectedYBottom->setRow(1, getArrayOfColor(CubeFace::Green));
